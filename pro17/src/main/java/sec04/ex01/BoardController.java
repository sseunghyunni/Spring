 ...
 * private static final long serialVersionUID = 1L; BoardService boardService;
 * ArticleVO articleVO; public void init(ServletConfig config) throws
 * ServletException { boardService = new BoardService(); }
 * 
 *//**
	 * @see Servlet#destroy()
	 */
 ...
 *//**
	 ...
	 *//*
		 ...
		 * method stub doHandle(request, response); } private void
		 * doHandle(HttpServletRequest request, HttpServletResponse response) throws
		 * ServletException, IOException{ String nextPage="";
		 ...
		 * if(action.equals("/*") || action.equals("/listArticles.do")) { articlesList =
		 * boardService.listArticles(); request.setAttribute("articlesList",
		 * articlesList); nextPage="/board01/listArticles.jsp"; } else { articlesList =
		 * boardService.listArticles(); request.setAttribute("articlesList",
